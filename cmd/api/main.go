...
func main() {
	...
	// old config - flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://postgres:@localhost/greenlight?sslmode=disable", "PostgreSQL DSN")
	...
	// Read the SMTP server configuration settings into the config struct, using the // Mailtrap settings as the default values. IMPORTANT: If you're following along, // make sure to replace the default values for smtp-username and smtp-password // with your own Mailtrap credentials.
	flag.StringVar(&cfg.smtp.host, "smtp-host", "smtp.mailtrap.io", "SMTP host")
	flag.IntVar(&cfg.smtp.port, "smtp-port", 25, "SMTP port")
	flag.StringVar(&cfg.smtp.username, "smtp-username", "79318fef7a07eb", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "e10762449ce95f", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@smtp.mailtrap.io>", "SMTP sender")
